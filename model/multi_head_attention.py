...
class MultiHeadedSelfAttention(nn.Module):
    ...
    def __init__(self, embedding_dim: int, attention_dim: int, nums_heads: int):
        super().__init__()
        torch.manual_seed(0)
        ...
        for i in range(0, nums_heads, 1):
            self.att_heads.append(self.SingleHeadAttention(embedding_dim, attention_dim//nums_heads))
